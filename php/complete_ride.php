...
if (isset($postdata) && !empty($postdata)) {
    ...
    $sql = "UPDATE bookings SET rating = '$rating', feedback = '$feedback', status = 'COMPLETED', driver_id = '$driver_id' WHERE booking_id = '$booking_id'";
    
    if ($mysqli->query($sql) === TRUE) {
        echo json_encode(['message' => 'Ride completed successfully']);
    } else {
